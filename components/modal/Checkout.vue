...
export default {
	...
	data () {
		return {
			modalTitle: 'Winkelwagen',
			removeLabel: 'Verwijder uit winkelwagen',
			cartEmptyLabel: 'Je winkelwagen is leeg',
			closeLabel: 'Sluit',
